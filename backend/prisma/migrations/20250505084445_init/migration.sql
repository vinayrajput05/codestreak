...
-- CreateEnum
CREATE TYPE "ProblemAtributeType" AS ENUM ('EXAMPLE', 'TESTCASE', 'CODE_SNIPPET', 'REFERENCE_SOLUTION');
...
-- CreateTable
CREATE TABLE "ProblemAtribute" (
    "id" TEXT NOT NULL,
    "problemId" TEXT NOT NULL,
    "type" "ProblemAtributeType" NOT NULL,
    "language" TEXT,
    "input" TEXT,
    "output" TEXT,
    "description" TEXT,
    ...
    CONSTRAINT "ProblemAtribute_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ProblemAtribute" ADD CONSTRAINT "ProblemAtribute_problemId_fkey" FOREIGN KEY ("problemId") REFERENCES "Problem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
